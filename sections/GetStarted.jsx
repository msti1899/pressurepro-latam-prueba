        ...
        >
          ...
          >
            <button
              ...
              className='px-5 py-3 rounded-xl bg-purple-500 text-white font-semibold text-sm shadow-md shadow-purple-500/20 hover:bg-purple-600 hover:-translate-y-0.5 hover:shadow-brand-red-500/30 transition-all duration-300 min-h-[48px] flex items-center gap-2'
            >

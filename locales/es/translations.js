...
export default {
    ...
    roiCalculator: {
        ...
        subtitle: 'Descubra cuánto puede ahorrar su flota implementando PressurePro. Ajuste los parámetros según su operación y obtenga una estimación de retorno de inversión.',
        currencyLabel: 'Moneda:',
        inputs: {
            fleetSize: 'Vehículos en la flota',
            tiresPerVehicle: 'Neumáticos por vehículo',
            tireCost: 'Costo por neumático',
            tireCostHint: 'Precio promedio de reemplazo de un neumático',
            fuelCostPerKm: 'Costo de combustible por km',
            kmPerYear: 'Kilómetros por vehículo al año',
            flatTireCost: 'Costo por pinchadura / avería',
            flatTireCostHint: 'Incluye mano de obra, demora y neumático de reemplazo',
            flatTiresRate: 'Averías por cada 100 vehículos al año',
            flatTiresRateUnit: 'eventos',
            flatTiresRateHint: 'Promedio de pinchaduras o pérdidas de presión graves por año',
        },
        results: {
            roiLabel: 'ROI estimado — primer año',
            paybackLabel: 'Recupero de inversión en {n} meses',
            roiNote: 'Beneficio neto ÷ inversión inicial × 100. Estimación basada en promedios de la industria (NHTSA, ATRI).',
            annualSavingsLabel: 'Ahorros anuales',
            annualSavingsNote: 'Lo que su flota deja de gastar cada año',
            investmentLabel: 'Resumen de inversión',
            investmentNote: 'Costo único de equipar toda la flota',
            tireWearSaving: 'Desgaste de neumáticos — 15% menos',
            fuelSaving: 'Combustible — 3% más eficiente',
            flatTiresSaving: 'Averías / pinchaduras — 80% menos',
            tpmsCost: 'Inversión total en TPMS (única)',
            totalSaving: 'Ahorro total anual',
            netBenefit: 'Beneficio neto primer año',
        },
        disclaimer: '* Estimación referencial. Ahorros calculados sobre base anual; la inversión en TPMS es un costo único para toda la flota (sensor $35 USD/neumático + instalación $150 USD/vehículo). Desgaste: reducción 15% (NHTSA); combustible: mejora 3% (Dept. of Energy); averías: reducción 80% (datos PressurePro). Los resultados reales pueden variar según operación y condiciones de la flota.',
    },
    countryBanner: {

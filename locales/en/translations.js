...
export default {
    ...
    roiCalculator: {
        ...
        subtitle: 'Discover how much your fleet can save by implementing PressurePro. Adjust the parameters for your operation and get a return on investment estimate.',
        currencyLabel: 'Currency:',
        inputs: {
            fleetSize: 'Vehicles in the fleet',
            tiresPerVehicle: 'Tires per vehicle',
            tireCost: 'Cost per tire',
            tireCostHint: 'Average replacement price of a tire',
            fuelCostPerKm: 'Fuel cost per km',
            kmPerYear: 'Kilometers per vehicle per year',
            flatTireCost: 'Cost per flat tire / breakdown',
            flatTireCostHint: 'Includes labor, downtime and replacement tire',
            flatTiresRate: 'Breakdowns per 100 vehicles per year',
            flatTiresRateUnit: 'events',
            flatTiresRateHint: 'Average flat tires or serious pressure losses per year',
        },
        results: {
            roiLabel: 'Estimated ROI — first year',
            paybackLabel: 'Payback period approx. {n} months',
            roiNote: 'Net benefit ÷ initial investment × 100. Estimate based on industry averages (NHTSA, ATRI).',
            annualSavingsLabel: 'Annual savings',
            annualSavingsNote: 'What your fleet stops spending every year',
            investmentLabel: 'Investment summary',
            investmentNote: 'One-time cost to equip the entire fleet',
            tireWearSaving: 'Tire wear — 15% reduction',
            fuelSaving: 'Fuel — 3% efficiency gain',
            flatTiresSaving: 'Flat tires / breakdowns — 80% fewer',
            tpmsCost: 'Total TPMS investment (one-time)',
            totalSaving: 'Total annual savings',
            netBenefit: 'Net benefit first year',
        },
        disclaimer: '* Reference estimate. Savings calculated on an annual basis; TPMS investment is a one-time cost for the entire fleet (sensor $35 USD/tire + installation $150 USD/vehicle). Tire wear: 15% reduction (NHTSA); fuel: 3% improvement (Dept. of Energy); breakdowns: 80% reduction (PressurePro data). Actual results may vary.',
    },
    countryBanner: {

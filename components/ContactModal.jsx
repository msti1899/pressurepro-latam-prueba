              ...
              <form onSubmit={handleSubmit} className='flex flex-col gap-3'>
                ...
                {type !== 'contact' && (
                  <div className='flex items-center gap-2 mb-1'>
                    <span className={`px-3 py-1 rounded-full text-xs font-semibold ${type === 'quote' ? 'bg-purple-600/30 text-purple-300 border border-purple-500/40' : 'bg-purple-600/30 text-purple-300 border border-purple-500/40'}`}>
                ...
                <button
                  ...
                  className='mt-2 w-full bg-purple-500 text-white font-semibold py-2.5 rounded-xl shadow-md hover:bg-purple-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed'
                >

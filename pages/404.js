...
export default function Custom404() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-primary-black text-white p-4 text-center">
      ...
      <h1 className="text-5xl md:text-7xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-brand-red-500">
        404
      </h1>
      ...
      <Link href="/" className="inline-flex items-center gap-2 bg-purple-500 text-white py-3 px-8 rounded-full hover:bg-purple-600 hover:shadow-lg hover:shadow-purple-500/30 transition-all transform hover:-translate-y-1">
